...
//jdbc:sqlserver://x.database.windows.net:1433;database=x;user=x@x;password=x;encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;loginTimeout=30;
