...
public class HD {
	...
	/**
     * @return Retorna o espaço total de um disco em GIGA passando o index do disco
     */
	...
	/**
     * @return Retorna o espaço em uso de um disco em GIGA passando o index do disco
     */
	...
	/**
     * @return Retorna o espaço disponível de um disco em GIGA passando o index do disco
     */
	...
	/**
     * @return Retorna o espaço total da partição de um disco em GIGA passando o index do disco
     */
